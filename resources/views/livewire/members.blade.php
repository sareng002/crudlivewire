            ...
            <button wire:click="create()" class="bg-indigo-600 hover:bg-indigo-800 text-white px-2 py-2 rounded-md flex ">
                ...
                <div class="flex items-center justify-end w-full ">
                    <p class="flex items-center mt-4">jumlah halaman: </p>
                        <select wire:model="pag" class=" mx-4  shadow appearance-nonerounded rounded-md  text-gray-700 leading-tight focus:outline-none focus:shadow-outline sm:mt-5  text-sm items-center " id="paginate">
                            <option value="5">5</option>
                            <option value="10">10</option>
                            <option value="15">15</option>
                            <option value="20">20</option>
                        </select>
                        <input wire:model="search" type="text" class=" shadow appearance-none border rounded  text-gray-700 leading-tight focus:outline-none focus:shadow-outline sm:mt-5  text-sm" placeholder="search">
                </div>
          ...
          <div class="">
               <table class="table w-full table-compact mt-4">
                ...
                <tbody>
                 ...
                 @empty
                     <tr>
                        <td class="border px-4 py-2 text-center bg-gray-500 text-white" colspan="6">Data Masih Kosong ....!</td>
                    </tr>
